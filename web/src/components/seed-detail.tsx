    ...
    <>
      <div className="scroll-area min-h-0 flex-1 overflow-y-auto">
        <div className="mx-auto flex max-w-[680px] flex-col px-[46px] pt-12 pb-8">
          {/* Hero: the idea is the thing you swipe on. */}
          ...
          <h1 className="mt-3.5 text-[clamp(40px,5vw,52px)] font-bold leading-[1.04] tracking-[-0.035em] text-ink text-balance">
            {seed.title}
          </h1>

          <p className="mt-6 text-[24px] font-medium leading-[1.34] tracking-[-0.02em] text-ink text-pretty">
            {seed.lead}
          </p>

          <p className="mt-5 text-[19px] leading-[1.5] tracking-[-0.012em] text-sub text-pretty">
            {seed.scope}
          </p>

          {/* Supporting metadata — compact, de-emphasized. */}
          <div className="mt-10 h-px w-full shrink-0 bg-border" />
