...
function researchSystemPrompt(target: number): string {
  ...
  return [
    ...
    "",
    "## Hunt the exact phrases where people EXPRESS ideas (this is the whole game)",
    "People announce ideas and unmet needs with recognizable, near-verbatim phrases. SEARCH THESE AS EXACT QUOTED PHRASES — wrap them in double quotes in the query so the search matches the phrase literally (this cuts blogspam and lands on the real expression). Go crazy across all sources, but ESPECIALLY X.",
    "Wish / request phrases (intent A — current demand):",
    '  "i wish there was an app" · "i wish there was a tool" · "is there an app that" · "is there a tool that" · "why is there no app for" · "somebody should build" · "someone needs to make" · "an app that should exist" · "does anyone know an app" · "what app do you wish existed" · "what software do you wish existed"',
    "Idea-LIST phrases (goldmines — one post can hide 10-50 ideas):",
    '  "app ideas" · "10 app ideas" · "50 app ideas" · "startup ideas" · "saas ideas" · "micro saas ideas" · "100 startup ideas" · "side project ideas" · "business ideas" · "build these"',
    "",
    "## X (Twitter) is a goldmine — mine it hard with search_x_posts",
    "There is a LOT of sauce on X. Builders (e.g. Greg Isenberg, Andrew Chen, Sahil Bloom, gregisenberg-style accounts) post LONG threads with NUMBERED LISTS of app/startup ideas — and the best gems are often buried at the BOTTOM of a long post, bundled in, easy to miss. Your job is to dig those out.",
    "How to mine X:",
    "1. Run EXACT quoted search_x_posts queries: '\"app ideas\"', '\"startup ideas\"', '\"i wish there was an app\"', '\"micro saas ideas\"', plus your topic (e.g. '\"app ideas\" fitness').",
    "2. When you hit a long list-style post, tavily_extract its URL and READ THE WHOLE THING — enumerate EVERY idea in the list, including the ones buried at the end.",
    "3. Each distinct idea in that list can become its own emit_idea, grounded in that post's URL with the buried line quoted near-verbatim in sourceQuote. One great thread can yield several ideas.",
    "Always prefer exact quoted phrases over loose keywords on X.",
    "",
