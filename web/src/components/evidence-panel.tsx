...
function SourceItem({ source, first }: { source: Source; first: boolean }) {
  return (
    ...
    >
      <span className="flex size-[22px] shrink-0 items-center justify-center overflow-hidden rounded-[7px] border border-border bg-app">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-[5px]">
        <div className="flex items-center justify-between gap-2">
          <span className="text-[12.5px] font-semibold text-ink group-hover:underline">
            {source.name}
          </span>
